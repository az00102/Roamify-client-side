        ...
        <div className="container mx-auto w-full flex justify-center my-10">
            ...
            <div className="w-full max-w-md p-4 rounded-md shadow sm:p-8 bg-gray-50 text-gray-800">
                ...
                <p className="text-sm text-center text-gray-600">Don't have an account?
                    <Link to={`/register`} rel="noopener noreferrer" className=" ml-2 underline text-green-500 font-bold">Sign up here</Link>
                </p>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                    ...
                    <button type="submit" className="w-full px-8 py-3 font-semibold rounded-md bg-green-500 text-gray-50">Sign in</button>
                </form>

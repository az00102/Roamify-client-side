const Review = () => {
    return (
        <div className='rounded-lg my-6'>
            <div className="flex flex-col max-w-xl p-8 shadow-sm rounded-xl lg:p-12 bg-gray-50 dark:bg-black dark:text-white">
                <div className="flex flex-col w-full">
                    ...
                    <div className="flex flex-wrap items-center mt-2 mb-1 space-x-2">
                        ...
                        <span className="dark:text-white">3 out of 5</span>
                    </div>
                    <p className="text-sm dark:text-white">861 global ratings</p>
